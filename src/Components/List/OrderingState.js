...
function OrderingState ({remainingWeight, price , toggleOrdering}) {
    ...
    return (
        <>
            ...
            <div>
                <button className='border-2 border-amber-500 bg-gray-300 px-2 mx-2'onClick={() => toggleOrdering()} >لغو</button>
                <button className='border-2 border-amber-500 bg-gray-300 px-2 mx-2'>افزودن به سبد خرید</button>
                <h2>وزن: {vazn} گرم</h2>
